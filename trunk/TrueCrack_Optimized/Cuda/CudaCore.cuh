...
void cuda_Kernel ( unsigned char *salt, unsigned char *header, unsigned char *blockPwd, int *blockPwd_init, int *blockPwd_length, short int *result, short int GPU_number, short int device_modulo, int offset);
